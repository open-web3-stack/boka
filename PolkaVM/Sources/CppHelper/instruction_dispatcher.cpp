    ...
    const DecodedInstruction& decoded)
{
    ...
    switch (opcode_from_u8(decoded.opcode)) {
        case Opcode::Trap:
    ...
    uint32_t block_end_pc)
{
    ...
    while (current_pc < block_end_pc) {
        ...
        switch (opcode_from_u8(opcode)) {
            ...
            case Opcode::MoveReg: // 2 register format (dest, src)
