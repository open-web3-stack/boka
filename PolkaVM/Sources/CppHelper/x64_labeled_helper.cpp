    ...
    void* _Nullable * _Nonnull funcOut)
{
    ...
    while (pc < codeSize) {
        ...
        if (opcode == 0) { // Trap
            ...
            jit_instruction::jit_generateTrap(&a, "x86_64");
            a.jmp(exitLabel);
            pc += instrSize;
            continue;
        }
...
// ARM64 version - similar structure
extern "C" int32_t compilePolkaVMCode_a64_labeled(
    ...
    void* _Nullable * _Nonnull funcOut)
{
    // TODO: Implement ARM64 labeled compilation
    // For now, fall back to existing implementation
    return compilePolkaVMCode_a64(codeBuffer, codeSize, initialPC, jitMemorySize, funcOut);
}
