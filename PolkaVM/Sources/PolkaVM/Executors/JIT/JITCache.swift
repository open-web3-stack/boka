...
// This file implements the caching mechanism for JIT-compiled functions.

import CryptoKit
import Foundation
import TracingUtils

// Key for the JIT compilation cache.
// It includes all factors that can change the output of a JIT compilation.
struct JITCacheKey: Hashable, Equatable, Sendable {
    ...
    // TODO: Consider adding PVM version or JIT compiler version to the key if internal JIT logic changes frequently.
}
