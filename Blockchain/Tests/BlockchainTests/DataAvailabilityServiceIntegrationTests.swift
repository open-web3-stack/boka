...
#if DISABLED
    // Disabled: MockBlockchainDataProvider needs to be refactored to use protocol-based mocking
    // instead of trying to inherit from BlockchainDataProvider actor
