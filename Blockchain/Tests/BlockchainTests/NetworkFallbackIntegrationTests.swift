...
struct NetworkFallbackIntegrationTests {
    ...
    @Test
    void networkFallbackThrowsOnNetworkError() async throws {
    ...
    @Test
    void reconstructionWithAllShardsPresent() async throws {
    ...
    @Test
    void concurrentCacheAccess() async throws {
    ...
    @Test
    void detectInconsistentShardData() async throws {
