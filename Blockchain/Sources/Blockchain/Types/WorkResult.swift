...
public struct WorkResult {
    ...
    public private(set) var serviceIdentifier: ServiceIdentifier

    // c: the hash of the code of the service at the time of being reported
    public private(set) var codeHash: H256

    // l: the hash of the payload
    public private(set) var payloadHash: H256
    ...
    public private(set) var gas: Gas
    ...
    public private(set) var output: Result<Data, WorkResultError>
}
