...
public struct State {
  ...
  public private(set) var coreAuthorizationPool:
    SizeLimitedArray<
      SizeLimitedArray<
        H256 /* maxLength: Constants.maxAuthorizationsPoolItems */
      > /* length: Constants.totalNumberofCores */
    >
  //  =
  //      SizeLimitedArray(
  //         deafultValue: SizeLimitedArray(deafultValue: H256.zero, minLength: 0, maxLength: Constants.maxAuthorizationsPoolItems),
  //     length: Constants.totalNumberofCores)
