...
private struct TrieNode {
    ...
    private init(left: Data32, right: Data32, type: TrieNodeType, isNew: Bool = false) {
    ...
    static func leaf(key: Data32, value: Data) -> TrieNode {
        ...
        if value.count <= 32 {
            ...
            return .init(left: Data32(newKey)!, right: Data32(newValue)!, type: .embeddedLeaf, isNew: true)
        }
        newKey.append(0b1100_0000)
        newKey += key.data.prefix(31)
        return .init(left: Data32(newKey)!, right: value.blake2b256hash(), type: .regularLeaf, isNew: true)
    }

    static func branch(left: Data32, right: Data32) -> TrieNode {
        .init(left: left, right: right, type: .branch, isNew: true)
    }
}
