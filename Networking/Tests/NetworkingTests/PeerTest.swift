...
final class PeerTests {
    ...
    func rejectsConDueToBadServerCert() async throws {
        ...
        #expect(reason == ConnectionCloseReason.transport(status: QuicStatus.code(QuicStatusCode.badCert), code: QuicErrorCode(298)))
    }
    ...
    func rejectsConDueToWrongCert() async throws {
        ...
        #expect(throws: QuicError.invalidStatus(
