...
public final class QuicServer {
    ...
    private func handleListenerEvent(_: OpaquePointer?, _ event: UnsafePointer<QuicListenerEvent>) -> QuicStatus {
    ...
    static let streamCallback:
        ...
        -> UInt32 = { _, _, event in
            guard let event else { return QuicStatusCode.invalidParameter.rawValue }
